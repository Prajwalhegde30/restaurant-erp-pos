...
export type GiftCardTransactionTypeType = `${z.infer<typeof GiftCardTransactionTypeSchema>}`;
...
export type PaymentRelations = {
  GiftCard?: GiftCardWithRelations | null;
  GiftCardTransaction: GiftCardTransactionWithRelations[];
...
export type CustomerRelations = {
  ...
  orders: OrderWithRelations[];
  invoices: InvoiceWithRelations[];
  couponUsages: CouponCustomerUsageWithRelations[];
  giftCards: GiftCardWithRelations[];
};

export type CustomerWithRelations = z.infer<typeof CustomerSchema> & CustomerRelations;

export const CustomerWithRelationsSchema: z.ZodType<CustomerWithRelations> = CustomerSchema.merge(
  z.object({
    tenant: z.lazy(() => TenantWithRelationsSchema),
...
export type LoyaltyLedgerWithRelations = z.infer<typeof LoyaltyLedgerSchema> &
  LoyaltyLedgerRelations;

export const LoyaltyLedgerWithRelationsSchema: z.ZodType<LoyaltyLedgerWithRelations> =
  LoyaltyLedgerSchema.merge(
    z.object({
      tenant: z.lazy(() => TenantWithRelationsSchema),
      customer: z.lazy(() => CustomerWithRelationsSchema),
...
export type CouponRelations = {
  tenant: TenantWithRelations;
  orders: OrderWithRelations[];
  usages: CouponCustomerUsageWithRelations[];
};

export type CouponWithRelations = z.infer<typeof CouponSchema> & CouponRelations;

export const CouponWithRelationsSchema: z.ZodType<CouponWithRelations> = CouponSchema.merge(
  z.object({
    tenant: z.lazy(() => TenantWithRelationsSchema),
    orders: z.lazy(() => OrderWithRelationsSchema).array(),
...
export type CouponCustomerUsage = z.infer<typeof CouponCustomerUsageSchema>;

// COUPON CUSTOMER USAGE RELATION SCHEMA
//------------------------------------------------------

export type CouponCustomerUsageRelations = {
  tenant: TenantWithRelations;
  coupon: CouponWithRelations;
  customer: CustomerWithRelations;
  order: OrderWithRelations;
...
export type CouponCustomerUsageWithRelations = z.infer<typeof CouponCustomerUsageSchema> &
  CouponCustomerUsageRelations;

export const CouponCustomerUsageWithRelationsSchema: z.ZodType<CouponCustomerUsageWithRelations> =
  CouponCustomerUsageSchema.merge(
    z.object({
      tenant: z.lazy(() => TenantWithRelationsSchema),
...
export type GiftCardRelations = {
  tenant: TenantWithRelations;
  customer?: CustomerWithRelations | null;
  transactions: GiftCardTransactionWithRelations[];
  payments: PaymentWithRelations[];
};

export type GiftCardWithRelations = z.infer<typeof GiftCardSchema> & GiftCardRelations;

export const GiftCardWithRelationsSchema: z.ZodType<GiftCardWithRelations> = GiftCardSchema.merge(
  z.object({
    tenant: z.lazy(() => TenantWithRelationsSchema),
    customer: z.lazy(() => CustomerWithRelationsSchema).nullable(),
...
// GIFT CARD TRANSACTION RELATION SCHEMA
//------------------------------------------------------

export type GiftCardTransactionRelations = {
  tenant: TenantWithRelations;
  giftCard: GiftCardWithRelations;
  order?: OrderWithRelations | null;
...
export type GiftCardTransactionWithRelations = z.infer<typeof GiftCardTransactionSchema> &
  GiftCardTransactionRelations;

export const GiftCardTransactionWithRelationsSchema: z.ZodType<GiftCardTransactionWithRelations> =
  GiftCardTransactionSchema.merge(
    z.object({
      tenant: z.lazy(() => TenantWithRelationsSchema),
