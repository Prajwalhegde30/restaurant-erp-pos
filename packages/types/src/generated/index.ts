...
export const TenantScalarFieldEnumSchema = z.enum(['id','name','status','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const BranchScalarFieldEnumSchema = z.enum(['id','tenantId','name','taxConfig','timezone','currency','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const UserScalarFieldEnumSchema = z.enum(['id','tenantId','email','firstName','lastName','pin','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const RoleScalarFieldEnumSchema = z.enum(['id','tenantId','parentId','name','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const PermissionScalarFieldEnumSchema = z.enum(['id','tenantId','roleId','module','resource','action','scope','thresholdKey','isDeny','effectiveFrom','effectiveUntil','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const UserRoleScalarFieldEnumSchema = z.enum(['id','tenantId','userId','roleId','branchId','effectiveFrom','effectiveUntil','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const BranchAssignmentScalarFieldEnumSchema = z.enum(['id','tenantId','userId','branchId','effectiveFrom','effectiveUntil','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const MenuScalarFieldEnumSchema = z.enum(['id','tenantId','name','description','status','version','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const MenuVersionScalarFieldEnumSchema = z.enum(['id','tenantId','menuId','name','description','status','version','recordedAt','recordedBy']);

export const MenuBranchScalarFieldEnumSchema = z.enum(['id','tenantId','menuId','branchId','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const CategoryScalarFieldEnumSchema = z.enum(['id','tenantId','menuId','parentId','name','description','sortOrder','status','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const MenuItemScalarFieldEnumSchema = z.enum(['id','tenantId','categoryId','name','description','price','taxRate','sortOrder','status','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const ModifierGroupScalarFieldEnumSchema = z.enum(['id','tenantId','name','minSelections','maxSelections','isRequired','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const ModifierOptionScalarFieldEnumSchema = z.enum(['id','tenantId','modifierGroupId','name','priceDelta','sortOrder','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const MenuItemModifierGroupScalarFieldEnumSchema = z.enum(['id','tenantId','menuItemId','modifierGroupId','sortOrder','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const ComboScalarFieldEnumSchema = z.enum(['id','tenantId','name','description','price','taxRate','status','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const ComboItemScalarFieldEnumSchema = z.enum(['id','tenantId','comboId','menuItemId','quantity','sortOrder','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const DiningTableScalarFieldEnumSchema = z.enum(['id','tenantId','branchId','tableNumber','capacity','status','floorSection','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const ReservationScalarFieldEnumSchema = z.enum(['id','tenantId','branchId','diningTableId','userId','guestName','guestPhone','partySize','scheduledAt','status','notes','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const OrderScalarFieldEnumSchema = z.enum(['id','tenantId','branchId','diningTableId','userId','status','orderType','parentOrderId','idempotencyKey','version','subtotal','taxAmount','totalAmount','notes','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt','customerId','couponId']);

export const OrderMergeScalarFieldEnumSchema = z.enum(['id','tenantId','parentOrderId','childOrderId','mergedAt','mergedBy','resolvedAt','resolvedBy','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const OrderItemScalarFieldEnumSchema = z.enum(['id','tenantId','orderId','menuItemId','status','quantity','unitPrice','taxRate','totalPrice','notes','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const OrderItemModifierSelectionScalarFieldEnumSchema = z.enum(['id','tenantId','orderItemId','modifierOptionId','priceDeltaSnapshot','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const OrderItemRecipeSnapshotScalarFieldEnumSchema = z.enum(['id','orderItemId','recipeId','recipeName','ingredientId','ingredientName','quantity','unit','yieldLossPct','spoilagePct','capturedAt']);

export const SupplierScalarFieldEnumSchema = z.enum(['id','tenantId','branchId','name','code','status','contactName','contactEmail','contactPhone','address','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const IngredientScalarFieldEnumSchema = z.enum(['id','tenantId','name','unit','unitCost','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const InventoryItemScalarFieldEnumSchema = z.enum(['id','tenantId','branchId','ingredientId','theoreticalQty','actualQty','reorderLevel','reorderQty','version','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const InventoryBatchScalarFieldEnumSchema = z.enum(['id','tenantId','branchId','ingredientId','batchNumber','receivedQty','remainingQty','unitCost','expiresAt','receivedAt','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const StockMovementScalarFieldEnumSchema = z.enum(['id','tenantId','branchId','ingredientId','movementType','quantityDelta','unitCost','referenceId','referenceType','notes','createdAt','createdBy']);

export const RecipeScalarFieldEnumSchema = z.enum(['id','tenantId','menuItemId','name','description','version','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const RecipeIngredientScalarFieldEnumSchema = z.enum(['id','tenantId','recipeId','ingredientId','branchId','quantity','unit','yieldLossPct','spoilagePct','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const PurchaseOrderScalarFieldEnumSchema = z.enum(['id','tenantId','branchId','supplierId','status','poNumber','subtotal','taxAmount','total','orderedAt','expectedAt','notes','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const PurchaseOrderItemScalarFieldEnumSchema = z.enum(['id','tenantId','purchaseOrderId','ingredientId','orderedQty','unit','unitCost','totalCost','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const GoodsReceiptScalarFieldEnumSchema = z.enum(['id','tenantId','branchId','purchaseOrderId','status','grnNumber','receivedAt','notes','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const GoodsReceiptItemScalarFieldEnumSchema = z.enum(['id','tenantId','goodsReceiptId','ingredientId','receivedQty','acceptedQty','rejectedQty','unit','unitCost','notes','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const LedgerAccountScalarFieldEnumSchema = z.enum(['id','tenantId','parentId','code','name','type','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const ShiftScalarFieldEnumSchema = z.enum(['id','tenantId','branchId','userId','status','openedAt','closedAt','openingFloat','closingFloat','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const CashDrawerScalarFieldEnumSchema = z.enum(['id','tenantId','branchId','shiftId','name','openingBalance','closingBalance','isOpen','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const DailyClosingScalarFieldEnumSchema = z.enum(['id','tenantId','branchId','closingDate','status','expectedCash','actualCash','variance','totalRevenue','notes','lockedAt','lockedBy','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const InvoiceScalarFieldEnumSchema = z.enum(['id','tenantId','branchId','orderId','status','subtotal','taxAmount','total','issuedAt','dueAt','notes','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt','customerId']);

export const PaymentScalarFieldEnumSchema = z.enum(['id','tenantId','invoiceId','status','method','amount','referenceCode','gatewayPayload','idempotencyKey','capturedAt','notes','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const RefundScalarFieldEnumSchema = z.enum(['id','tenantId','invoiceId','paymentId','status','amount','reason','notes','approvedBy','approvedAt','idempotencyKey','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const JournalScalarFieldEnumSchema = z.enum(['id','tenantId','shiftId','description','referenceId','referenceType','isPosted','postedAt','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const JournalEntryScalarFieldEnumSchema = z.enum(['id','tenantId','journalId','ledgerAccountId','entryType','amount','description','createdAt','createdBy']);

export const AuditLogScalarFieldEnumSchema = z.enum(['id','tenantId','userId','entityType','entityId','action','beforeState','afterState','reason','ipAddress','userAgent','correlationId','createdAt']);

export const ConfigurationScalarFieldEnumSchema = z.enum(['id','level','key','value','tenantId','branchId','stationId','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const FiscalPeriodScalarFieldEnumSchema = z.enum(['id','tenantId','name','startDate','endDate','isClosed','closedAt','closedBy','createdAt','updatedAt','isDeleted']);

export const CostCenterScalarFieldEnumSchema = z.enum(['id','tenantId','branchId','code','name','description','createdAt','updatedAt','isDeleted']);

export const SupplierInvoiceScalarFieldEnumSchema = z.enum(['id','tenantId','branchId','supplierId','purchaseOrderId','invoiceNumber','invoiceDate','dueDate','totalAmount','taxAmount','status','createdAt','updatedAt','createdBy','updatedBy','isDeleted']);

export const CustomerScalarFieldEnumSchema = z.enum(['id','tenantId','firstName','lastName','email','phone','status','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const MembershipScalarFieldEnumSchema = z.enum(['id','tenantId','customerId','tier','joinedAt','expiresAt','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const LoyaltyLedgerScalarFieldEnumSchema = z.enum(['id','tenantId','customerId','orderId','points','type','reason','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const CouponScalarFieldEnumSchema = z.enum(['id','tenantId','code','type','value','minOrderValue','status','validFrom','validUntil','maxUses','currentUses','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);

export const GiftCardScalarFieldEnumSchema = z.enum(['id','tenantId','code','initialValue','currentBalance','status','expiresAt','createdAt','updatedAt','createdBy','updatedBy','isDeleted','deletedAt']);
...
export const OrderStatusSchema = z.enum(['DRAFT','PLACED','IN_PREP','READY','SERVED','PAID','CLOSED','VOIDED','CANCELLED']);
...
export const IngredientUnitSchema = z.enum(['KG','G','L','ML','PIECE','PORTION','BOX','PACK']);

export type IngredientUnitType = `${z.infer<typeof IngredientUnitSchema>}`

export const StockMovementTypeSchema = z.enum(['PURCHASE','CONSUMPTION','SPOILAGE','TRANSFER_IN','TRANSFER_OUT','ADJUSTMENT','RETURN']);
...
export const InvoiceStatusSchema = z.enum(['DRAFT','ISSUED','PARTIALLY_PAID','PAID','VOIDED','REFUNDED']);

export type InvoiceStatusType = `${z.infer<typeof InvoiceStatusSchema>}`

export const PaymentStatusSchema = z.enum(['INITIATED','AUTHORIZED','CAPTURED','FAILED','VOIDED','REFUNDED']);

export type PaymentStatusType = `${z.infer<typeof PaymentStatusSchema>}`

export const PaymentMethodSchema = z.enum(['CASH','CARD','MOBILE','GIFT_CARD','LOYALTY','SPLIT']);
...
export type CouponStatusType = `${z.infer<typeof CouponStatusSchema>}`

export const GiftCardStatusSchema = z.enum(['ACTIVE','EXPIRED','DEPLETED','BLOCKED']);

export type GiftCardStatusType = `${z.infer<typeof GiftCardStatusSchema>}`

export const LoyaltyTransactionTypeSchema = z.enum(['EARNED','REDEEMED','EXPIRED','ADJUSTED']);

export type LoyaltyTransactionTypeType = `${z.infer<typeof LoyaltyTransactionTypeSchema>}`
...
export type TenantRelations = {
  ...
  LoyaltyLedger: LoyaltyLedgerWithRelations[];
...
export type BranchAssignmentWithRelations = z.infer<typeof BranchAssignmentSchema> & BranchAssignmentRelations

export const BranchAssignmentWithRelationsSchema: z.ZodType<BranchAssignmentWithRelations> = BranchAssignmentSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
  user: z.lazy(() => UserWithRelationsSchema),
...
export const MenuVersionWithRelationsSchema: z.ZodType<MenuVersionWithRelations> = MenuVersionSchema.merge(z.object({
...
export const MenuBranchWithRelationsSchema: z.ZodType<MenuBranchWithRelations> = MenuBranchSchema.merge(z.object({
  menu: z.lazy(() => MenuWithRelationsSchema),
  branch: z.lazy(() => BranchWithRelationsSchema),
}))
...
export const MenuItemSchema = z.object({
  ...
  name: z.string(),
  description: z.string().nullable(),
  price: z.instanceof(Prisma.Decimal, { message: "Field 'price' must be a Decimal. Location: ['Models', 'MenuItem']"}),
  taxRate: z.instanceof(Prisma.Decimal, { message: "Field 'taxRate' must be a Decimal. Location: ['Models', 'MenuItem']"}),
  sortOrder: z.number().int(),
  createdAt: z.coerce.date(),
  updatedAt: z.coerce.date(),
  createdBy: z.string().nullable(),
...
export type ModifierGroupWithRelations = z.infer<typeof ModifierGroupSchema> & ModifierGroupRelations

export const ModifierGroupWithRelationsSchema: z.ZodType<ModifierGroupWithRelations> = ModifierGroupSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
  modifierOptions: z.lazy(() => ModifierOptionWithRelationsSchema).array(),
  menuItemModifierGroups: z.lazy(() => MenuItemModifierGroupWithRelationsSchema).array(),
}))
...
export const ModifierOptionSchema = z.object({
  ...
  name: z.string(),
  priceDelta: z.instanceof(Prisma.Decimal, { message: "Field 'priceDelta' must be a Decimal. Location: ['Models', 'ModifierOption']"}),
  sortOrder: z.number().int(),
  createdAt: z.coerce.date(),
  updatedAt: z.coerce.date(),
  createdBy: z.string().nullable(),
...
export type ModifierOptionWithRelations = z.infer<typeof ModifierOptionSchema> & ModifierOptionRelations

export const ModifierOptionWithRelationsSchema: z.ZodType<ModifierOptionWithRelations> = ModifierOptionSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
  modifierGroup: z.lazy(() => ModifierGroupWithRelationsSchema),
  orderItemModifierSelections: z.lazy(() => OrderItemModifierSelectionWithRelationsSchema).array(),
}))
...
export type MenuItemModifierGroupWithRelations = z.infer<typeof MenuItemModifierGroupSchema> & MenuItemModifierGroupRelations

export const MenuItemModifierGroupWithRelationsSchema: z.ZodType<MenuItemModifierGroupWithRelations> = MenuItemModifierGroupSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
...
export const ComboSchema = z.object({
  ...
  name: z.string(),
  description: z.string().nullable(),
  price: z.instanceof(Prisma.Decimal, { message: "Field 'price' must be a Decimal. Location: ['Models', 'Combo']"}),
  taxRate: z.instanceof(Prisma.Decimal, { message: "Field 'taxRate' must be a Decimal. Location: ['Models', 'Combo']"}),
  createdAt: z.coerce.date(),
  updatedAt: z.coerce.date(),
  createdBy: z.string().nullable(),
  updatedBy: z.string().nullable(),
...
export const ComboWithRelationsSchema: z.ZodType<ComboWithRelations> = ComboSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
  comboItems: z.lazy(() => ComboItemWithRelationsSchema).array(),
}))
...
export const ComboItemWithRelationsSchema: z.ZodType<ComboItemWithRelations> = ComboItemSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
...
export const DiningTableWithRelationsSchema: z.ZodType<DiningTableWithRelations> = DiningTableSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
  branch: z.lazy(() => BranchWithRelationsSchema),
  reservations: z.lazy(() => ReservationWithRelationsSchema).array(),
  orders: z.lazy(() => OrderWithRelationsSchema).array(),
...
export const OrderMergeWithRelationsSchema: z.ZodType<OrderMergeWithRelations> = OrderMergeSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
...
export const OrderItemSchema = z.object({
  ...
  taxRate: z.instanceof(Prisma.Decimal, { message: "Field 'taxRate' must be a Decimal. Location: ['Models', 'OrderItem']"}),
  totalPrice: z.instanceof(Prisma.Decimal, { message: "Field 'totalPrice' must be a Decimal. Location: ['Models', 'OrderItem']"}),
  notes: z.string().nullable(),
  createdAt: z.coerce.date(),
  updatedAt: z.coerce.date(),
  createdBy: z.string().nullable(),
...
export const OrderItemModifierSelectionSchema = z.object({
  ...
  priceDeltaSnapshot: z.instanceof(Prisma.Decimal, { message: "Field 'priceDeltaSnapshot' must be a Decimal. Location: ['Models', 'OrderItemModifierSelection']"}),
  createdAt: z.coerce.date(),
  updatedAt: z.coerce.date(),
  createdBy: z.string().nullable(),
  updatedBy: z.string().nullable(),
...
export type OrderItemModifierSelectionWithRelations = z.infer<typeof OrderItemModifierSelectionSchema> & OrderItemModifierSelectionRelations

export const OrderItemModifierSelectionWithRelationsSchema: z.ZodType<OrderItemModifierSelectionWithRelations> = OrderItemModifierSelectionSchema.merge(z.object({
...
export const OrderItemRecipeSnapshotSchema = z.object({
  ...
  quantity: z.instanceof(Prisma.Decimal, { message: "Field 'quantity' must be a Decimal. Location: ['Models', 'OrderItemRecipeSnapshot']"}),
  unit: z.string(),
  yieldLossPct: z.instanceof(Prisma.Decimal, { message: "Field 'yieldLossPct' must be a Decimal. Location: ['Models', 'OrderItemRecipeSnapshot']"}),
  spoilagePct: z.instanceof(Prisma.Decimal, { message: "Field 'spoilagePct' must be a Decimal. Location: ['Models', 'OrderItemRecipeSnapshot']"}),
...
export type OrderItemRecipeSnapshotWithRelations = z.infer<typeof OrderItemRecipeSnapshotSchema> & OrderItemRecipeSnapshotRelations

export const OrderItemRecipeSnapshotWithRelationsSchema: z.ZodType<OrderItemRecipeSnapshotWithRelations> = OrderItemRecipeSnapshotSchema.merge(z.object({
  orderItem: z.lazy(() => OrderItemWithRelationsSchema),
}))
...
export const SupplierWithRelationsSchema: z.ZodType<SupplierWithRelations> = SupplierSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
  branch: z.lazy(() => BranchWithRelationsSchema).nullable(),
  purchaseOrders: z.lazy(() => PurchaseOrderWithRelationsSchema).array(),
  supplierInvoices: z.lazy(() => SupplierInvoiceWithRelationsSchema).array(),
...
export const IngredientSchema = z.object({
  ...
  tenantId: z.string(),
  name: z.string(),
  unitCost: z.instanceof(Prisma.Decimal, { message: "Field 'unitCost' must be a Decimal. Location: ['Models', 'Ingredient']"}),
  createdAt: z.coerce.date(),
  updatedAt: z.coerce.date(),
  createdBy: z.string().nullable(),
  updatedBy: z.string().nullable(),
...
export const InventoryItemSchema = z.object({
  ...
  branchId: z.string(),
  ingredientId: z.string(),
  theoreticalQty: z.instanceof(Prisma.Decimal, { message: "Field 'theoreticalQty' must be a Decimal. Location: ['Models', 'InventoryItem']"}),
  actualQty: z.instanceof(Prisma.Decimal, { message: "Field 'actualQty' must be a Decimal. Location: ['Models', 'InventoryItem']"}),
  reorderLevel: z.instanceof(Prisma.Decimal, { message: "Field 'reorderLevel' must be a Decimal. Location: ['Models', 'InventoryItem']"}).nullable(),
  reorderQty: z.instanceof(Prisma.Decimal, { message: "Field 'reorderQty' must be a Decimal. Location: ['Models', 'InventoryItem']"}).nullable(),
  version: z.number().int(),
  createdAt: z.coerce.date(),
  updatedAt: z.coerce.date(),
  createdBy: z.string().nullable(),
...
export const InventoryBatchSchema = z.object({
  ...
  receivedQty: z.instanceof(Prisma.Decimal, { message: "Field 'receivedQty' must be a Decimal. Location: ['Models', 'InventoryBatch']"}),
  remainingQty: z.instanceof(Prisma.Decimal, { message: "Field 'remainingQty' must be a Decimal. Location: ['Models', 'InventoryBatch']"}),
  unitCost: z.instanceof(Prisma.Decimal, { message: "Field 'unitCost' must be a Decimal. Location: ['Models', 'InventoryBatch']"}),
...
export type InventoryBatchWithRelations = z.infer<typeof InventoryBatchSchema> & InventoryBatchRelations

export const InventoryBatchWithRelationsSchema: z.ZodType<InventoryBatchWithRelations> = InventoryBatchSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
  branch: z.lazy(() => BranchWithRelationsSchema),
  ingredient: z.lazy(() => IngredientWithRelationsSchema),
}))
...
export const StockMovementSchema = z.object({
  ...
  branchId: z.string(),
  ingredientId: z.string(),
  quantityDelta: z.instanceof(Prisma.Decimal, { message: "Field 'quantityDelta' must be a Decimal. Location: ['Models', 'StockMovement']"}),
  unitCost: z.instanceof(Prisma.Decimal, { message: "Field 'unitCost' must be a Decimal. Location: ['Models', 'StockMovement']"}),
...
export type StockMovementWithRelations = z.infer<typeof StockMovementSchema> & StockMovementRelations

export const StockMovementWithRelationsSchema: z.ZodType<StockMovementWithRelations> = StockMovementSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
  branch: z.lazy(() => BranchWithRelationsSchema),
  ingredient: z.lazy(() => IngredientWithRelationsSchema),
}))
...
export const RecipeIngredientSchema = z.object({
  ...
  ingredientId: z.string(),
  branchId: z.string().nullable(),
  quantity: z.instanceof(Prisma.Decimal, { message: "Field 'quantity' must be a Decimal. Location: ['Models', 'RecipeIngredient']"}),
  yieldLossPct: z.instanceof(Prisma.Decimal, { message: "Field 'yieldLossPct' must be a Decimal. Location: ['Models', 'RecipeIngredient']"}),
  spoilagePct: z.instanceof(Prisma.Decimal, { message: "Field 'spoilagePct' must be a Decimal. Location: ['Models', 'RecipeIngredient']"}),
  createdAt: z.coerce.date(),
  updatedAt: z.coerce.date(),
  createdBy: z.string().nullable(),
  updatedBy: z.string().nullable(),
...
export const PurchaseOrderSchema = z.object({
  ...
  supplierId: z.string(),
  poNumber: z.string(),
  subtotal: z.instanceof(Prisma.Decimal, { message: "Field 'subtotal' must be a Decimal. Location: ['Models', 'PurchaseOrder']"}),
  taxAmount: z.instanceof(Prisma.Decimal, { message: "Field 'taxAmount' must be a Decimal. Location: ['Models', 'PurchaseOrder']"}),
  total: z.instanceof(Prisma.Decimal, { message: "Field 'total' must be a Decimal. Location: ['Models', 'PurchaseOrder']"}),
...
export const PurchaseOrderItemSchema = z.object({
  ...
  ingredientId: z.string(),
  orderedQty: z.instanceof(Prisma.Decimal, { message: "Field 'orderedQty' must be a Decimal. Location: ['Models', 'PurchaseOrderItem']"}),
  unitCost: z.instanceof(Prisma.Decimal, { message: "Field 'unitCost' must be a Decimal. Location: ['Models', 'PurchaseOrderItem']"}),
  totalCost: z.instanceof(Prisma.Decimal, { message: "Field 'totalCost' must be a Decimal. Location: ['Models', 'PurchaseOrderItem']"}),
  createdAt: z.coerce.date(),
  updatedAt: z.coerce.date(),
  createdBy: z.string().nullable(),
  updatedBy: z.string().nullable(),
...
export type PurchaseOrderItemWithRelations = z.infer<typeof PurchaseOrderItemSchema> & PurchaseOrderItemRelations

export const PurchaseOrderItemWithRelationsSchema: z.ZodType<PurchaseOrderItemWithRelations> = PurchaseOrderItemSchema.merge(z.object({
...
export const GoodsReceiptWithRelationsSchema: z.ZodType<GoodsReceiptWithRelations> = GoodsReceiptSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
  branch: z.lazy(() => BranchWithRelationsSchema),
  purchaseOrder: z.lazy(() => PurchaseOrderWithRelationsSchema),
  goodsReceiptItems: z.lazy(() => GoodsReceiptItemWithRelationsSchema).array(),
...
export const GoodsReceiptItemSchema = z.object({
  ...
  ingredientId: z.string(),
  receivedQty: z.instanceof(Prisma.Decimal, { message: "Field 'receivedQty' must be a Decimal. Location: ['Models', 'GoodsReceiptItem']"}),
  acceptedQty: z.instanceof(Prisma.Decimal, { message: "Field 'acceptedQty' must be a Decimal. Location: ['Models', 'GoodsReceiptItem']"}),
  rejectedQty: z.instanceof(Prisma.Decimal, { message: "Field 'rejectedQty' must be a Decimal. Location: ['Models', 'GoodsReceiptItem']"}),
  unitCost: z.instanceof(Prisma.Decimal, { message: "Field 'unitCost' must be a Decimal. Location: ['Models', 'GoodsReceiptItem']"}),
  notes: z.string().nullable(),
  createdAt: z.coerce.date(),
  updatedAt: z.coerce.date(),
  createdBy: z.string().nullable(),
...
export type GoodsReceiptItemWithRelations = z.infer<typeof GoodsReceiptItemSchema> & GoodsReceiptItemRelations

export const GoodsReceiptItemWithRelationsSchema: z.ZodType<GoodsReceiptItemWithRelations> = GoodsReceiptItemSchema.merge(z.object({
...
export type LedgerAccountWithRelations = z.infer<typeof LedgerAccountSchema> & LedgerAccountRelations

export const LedgerAccountWithRelationsSchema: z.ZodType<LedgerAccountWithRelations> = LedgerAccountSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
...
export const ShiftSchema = z.object({
  ...
  openingFloat: z.instanceof(Prisma.Decimal, { message: "Field 'openingFloat' must be a Decimal. Location: ['Models', 'Shift']"}),
  closingFloat: z.instanceof(Prisma.Decimal, { message: "Field 'closingFloat' must be a Decimal. Location: ['Models', 'Shift']"}).nullable(),
  createdAt: z.coerce.date(),
  updatedAt: z.coerce.date(),
  createdBy: z.string().nullable(),
  updatedBy: z.string().nullable(),
...
export const CashDrawerSchema = z.object({
  ...
  shiftId: z.string(),
  name: z.string(),
  openingBalance: z.instanceof(Prisma.Decimal, { message: "Field 'openingBalance' must be a Decimal. Location: ['Models', 'CashDrawer']"}),
  closingBalance: z.instanceof(Prisma.Decimal, { message: "Field 'closingBalance' must be a Decimal. Location: ['Models', 'CashDrawer']"}).nullable(),
  isOpen: z.boolean(),
  createdAt: z.coerce.date(),
  updatedAt: z.coerce.date(),
  createdBy: z.string().nullable(),
...
export const CashDrawerWithRelationsSchema: z.ZodType<CashDrawerWithRelations> = CashDrawerSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
  branch: z.lazy(() => BranchWithRelationsSchema),
...
export const DailyClosingSchema = z.object({
  ...
  expectedCash: z.instanceof(Prisma.Decimal, { message: "Field 'expectedCash' must be a Decimal. Location: ['Models', 'DailyClosing']"}),
  actualCash: z.instanceof(Prisma.Decimal, { message: "Field 'actualCash' must be a Decimal. Location: ['Models', 'DailyClosing']"}),
  variance: z.instanceof(Prisma.Decimal, { message: "Field 'variance' must be a Decimal. Location: ['Models', 'DailyClosing']"}),
  totalRevenue: z.instanceof(Prisma.Decimal, { message: "Field 'totalRevenue' must be a Decimal. Location: ['Models', 'DailyClosing']"}),
  notes: z.string().nullable(),
...
export const DailyClosingWithRelationsSchema: z.ZodType<DailyClosingWithRelations> = DailyClosingSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
  branch: z.lazy(() => BranchWithRelationsSchema),
}))
...
export const RefundSchema = z.object({
  ...
  invoiceId: z.string(),
  paymentId: z.string(),
  amount: z.instanceof(Prisma.Decimal, { message: "Field 'amount' must be a Decimal. Location: ['Models', 'Refund']"}),
  reason: z.string(),
  notes: z.string().nullable(),
...
export const RefundWithRelationsSchema: z.ZodType<RefundWithRelations> = RefundSchema.merge(z.object({
  invoice: z.lazy(() => InvoiceWithRelationsSchema),
...
export const JournalWithRelationsSchema: z.ZodType<JournalWithRelations> = JournalSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
...
export const JournalEntrySchema = z.object({
  ...
  amount: z.instanceof(Prisma.Decimal, { message: "Field 'amount' must be a Decimal. Location: ['Models', 'JournalEntry']"}),
  description: z.string().nullable(),
  createdAt: z.coerce.date(),
  createdBy: z.string().nullable(),
})
...
export const JournalEntryWithRelationsSchema: z.ZodType<JournalEntryWithRelations> = JournalEntrySchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
...
export type AuditLogWithRelations = Omit<z.infer<typeof AuditLogSchema>, "beforeState" | "afterState"> & {
...
export type ConfigurationWithRelations = z.infer<typeof ConfigurationSchema> & ConfigurationRelations

export const ConfigurationWithRelationsSchema: z.ZodType<ConfigurationWithRelations> = ConfigurationSchema.merge(z.object({
...
export const FiscalPeriodWithRelationsSchema: z.ZodType<FiscalPeriodWithRelations> = FiscalPeriodSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
}))
...
export const CostCenterWithRelationsSchema: z.ZodType<CostCenterWithRelations> = CostCenterSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
  branch: z.lazy(() => BranchWithRelationsSchema).nullable(),
}))
...
export const SupplierInvoiceSchema = z.object({
  ...
  totalAmount: z.instanceof(Prisma.Decimal, { message: "Field 'totalAmount' must be a Decimal. Location: ['Models', 'SupplierInvoice']"}),
  taxAmount: z.instanceof(Prisma.Decimal, { message: "Field 'taxAmount' must be a Decimal. Location: ['Models', 'SupplierInvoice']"}),
  createdAt: z.coerce.date(),
  updatedAt: z.coerce.date(),
  createdBy: z.string().nullable(),
  updatedBy: z.string().nullable(),
...
export type SupplierInvoiceWithRelations = z.infer<typeof SupplierInvoiceSchema> & SupplierInvoiceRelations

export const SupplierInvoiceWithRelationsSchema: z.ZodType<SupplierInvoiceWithRelations> = SupplierInvoiceSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
  branch: z.lazy(() => BranchWithRelationsSchema),
  supplier: z.lazy(() => SupplierWithRelationsSchema),
...
export type CustomerRelations = {
  ...
  loyaltyLedgers: LoyaltyLedgerWithRelations[];
  orders: OrderWithRelations[];
  invoices: InvoiceWithRelations[];
};
...
// LOYALTY LEDGER RELATION SCHEMA
//------------------------------------------------------

export type LoyaltyLedgerRelations = {
  tenant: TenantWithRelations;
  customer: CustomerWithRelations;
  order?: OrderWithRelations | null;
};

export type LoyaltyLedgerWithRelations = z.infer<typeof LoyaltyLedgerSchema> & LoyaltyLedgerRelations

export const LoyaltyLedgerWithRelationsSchema: z.ZodType<LoyaltyLedgerWithRelations> = LoyaltyLedgerSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
  customer: z.lazy(() => CustomerWithRelationsSchema),
...
export const CouponSchema = z.object({
  ...
  tenantId: z.string(),
  code: z.string(),
  value: z.instanceof(Prisma.Decimal, { message: "Field 'value' must be a Decimal. Location: ['Models', 'Coupon']"}),
  minOrderValue: z.instanceof(Prisma.Decimal, { message: "Field 'minOrderValue' must be a Decimal. Location: ['Models', 'Coupon']"}).nullable(),
...
export const GiftCardSchema = z.object({
  ...
  tenantId: z.string(),
  code: z.string(),
  initialValue: z.instanceof(Prisma.Decimal, { message: "Field 'initialValue' must be a Decimal. Location: ['Models', 'GiftCard']"}),
  currentBalance: z.instanceof(Prisma.Decimal, { message: "Field 'currentBalance' must be a Decimal. Location: ['Models', 'GiftCard']"}),
  expiresAt: z.coerce.date().nullable(),
  createdAt: z.coerce.date(),
  updatedAt: z.coerce.date(),
  createdBy: z.string().nullable(),
...
// GIFT CARD RELATION SCHEMA
//------------------------------------------------------

export type GiftCardRelations = {
  tenant: TenantWithRelations;
};

export type GiftCardWithRelations = z.infer<typeof GiftCardSchema> & GiftCardRelations

export const GiftCardWithRelationsSchema: z.ZodType<GiftCardWithRelations> = GiftCardSchema.merge(z.object({
  tenant: z.lazy(() => TenantWithRelationsSchema),
}))
